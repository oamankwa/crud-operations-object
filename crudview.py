...
mydb = mysql.connector.connect(host="sql9.freemysqlhosting.net", user="sql9634058", passwd="VpWiQ5vKCR", database="sql9634058")
...
#mycrud.add_csv('locations','/home/edward/Project-Crud/Crud/addcsv.csv', onelist, mycursor, mydb)
